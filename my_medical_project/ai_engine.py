...
# ---------------------------------------------------------
# ---------------------------------------------------------
# 📚 ฐานข้อมูลคู่มือแพทย์ (MEDICAL_DICTIONARY) อัปเกรดฉบับสมบูรณ์!
# ---------------------------------------------------------
MEDICAL_DICTIONARY = {
    # --- กลุ่มไขมัน ---
    ...
    "HDL-C": {"meaning": "ไขมันดี (ตัวเก็บกวาดขยะหลอดเลือด) ยิ่งสูงยิ่งดี", "normal": "> 40", "unit": "mg/dL"},
    "LDL": {"meaning": "ไขมันเลว (ตัวทำหลอดเลือดตีบ) ยิ่งน้อยยิ่งดี", "normal": "< 100", "unit": "mg/dL"},
    
    # --- กลุ่มน้ำตาล ---
    "GLUCOSE": {"meaning": "ระดับน้ำตาลในเลือดตอนอดอาหาร (เช็คเบาหวาน)", "normal": "70 - 99", "unit": "mg/dL"},
    "HBA1C": {"meaning": "น้ำตาลสะสมเฉลี่ยในรอบ 3 เดือน (แม่นยำกว่าน้ำตาลปกติ)", "normal": "< 5.7", "unit": "%"},
    
    # --- กลุ่มการทำงานของไตและเก๊าท์ ---
    "CREATININE": {"meaning": "ของเสียจากกล้ามเนื้อ (ถ้าไตทำงานลดลง ค่านี้จะสูง)", "normal": "0.6 - 1.2", "unit": "mg/dL"},
    "GFR": {"meaning": "ประสิทธิภาพการกรองของไต (บอกระยะโรคไต) ยิ่งสูงยิ่งดี", "normal": "> 90", "unit": "mL/min/1.73m²"},
    "URIC ACID": {"meaning": "กรดยูริก (ถ้าสูงเกินไปจะตกตะกอนตามข้อเป็นโรคเก๊าท์)", "normal": "3.5 - 7.2", "unit": "mg/dL"},
    "A:C": {"meaning": "อัตราส่วนโปรตีนอัลบูมินต่อครีอะตินีนในปัสสาวะ (เช็คโปรตีนรั่วจากไต)", "normal": "< 30", "unit": "mg/g"},
    
    # --- กลุ่มตับและเกลือแร่ ---
    "AST": {"meaning": "เอนไซม์ตับ (ถ้าสูงแปลว่าเซลล์ตับ/กล้ามเนื้ออาจอักเสบ)", "normal": "10 - 40", "unit": "U/L"},
    "ALT": {"meaning": "เอนไซม์ตับ (เฉพาะเจาะจงกับตับ ถ้าสูงแปลว่าตับอักเสบ)", "normal": "9 - 43", "unit": "U/L"},
    "SODIUM": {"meaning": "โซเดียม (เกลือแร่ในเลือด เช็คภาวะขาดน้ำ/บวมน้ำ)", "normal": "135 - 145", "unit": "mEq/L"},
    "POTASSIUM": {"meaning": "โพแทสเซียม (เกลือแร่สำคัญที่คุมการเต้นของหัวใจและกล้ามเนื้อ)", "normal": "3.5 - 5.1", "unit": "mEq/L"},
    
    # --- กลุ่มความสมบูรณ์ของเม็ดเลือดแดง (CBC) ---
    "RBC": {"meaning": "จำนวนเม็ดเลือดแดง (ตัวพาออกซิเจนไปเลี้ยงร่างกาย)", "normal": "4.5 - 6.1", "unit": "10^6/uL"},
    "HCT": {"meaning": "ความเข้มข้นของเม็ดเลือดแดง (เช็คภาวะซีด หรือเลือดข้นไป)", "normal": "36 - 50", "unit": "%"},
    "MCV": {"meaning": "ขนาดปริมาตรเฉลี่ยของเม็ดเลือดแดง (เช็คชนิดของภาวะโลหิตจาง)", "normal": "80 - 100", "unit": "fL"},
    "MCH": {"meaning": "น้ำหนักฮีโมโกลบินเฉลี่ยในเม็ดเลือดแดง", "normal": "27 - 33", "unit": "pg"},
    "MCHC": {"meaning": "ความเข้มข้นของฮีโมโกลบินในเม็ดเลือดแดง", "normal": "32 - 36", "unit": "g/dL"},
    
    # --- กลุ่มเม็ดเลือดขาว (ภูมิคุ้มกัน) ---
    "NEUTROPHIL": {"meaning": "เม็ดเลือดขาวชนิดสู้แบคทีเรียและจัดการการติดเชื้อเฉียบพลัน", "normal": "40 - 75", "unit": "%"},
    "NE#": {"meaning": "จำนวนเม็ดเลือดขาวนิวโทรฟิลแบบสัมบูรณ์ (ปริมาณจริงในเลือด)", "normal": "2.0 - 7.0", "unit": "10^3/uL"},
    "LYMPHOCYTE": {"meaning": "เม็ดเลือดขาวชนิดสู้ไวรัสและการติดเชื้อเรื้อรัง", "normal": "20 - 40", "unit": "%"},
    "EOSINOPHIL": {"meaning": "เม็ดเลือดขาวชนิดสู้พยาธิและตอบสนองต่อภูมิแพ้", "normal": "1 - 4", "unit": "%"},
    "BASOPHIL": {"meaning": "เม็ดเลือดขาวชนิดสู้ภูมิแพ้ชนิดรุนแรง", "normal": "0 - 1", "unit": "%"},
    
    # --- กลุ่มเกล็ดเลือด ---
    "PLATELET COUNT": {"meaning": "ปริมาณเกล็ดเลือด (ช่วยในการแข็งตัวของเลือดเวลาเกิดแผล)", "normal": "150 - 400", "unit": "10^3/uL"},
    "MPV": {"meaning": "ขนาดเฉลี่ยของเกล็ดเลือด (บ่งบอกการสร้างเกล็ดเลือดใหม่)", "normal": "7.0 - 11.0", "unit": "fL"}
}
